...
import os
import numpy as np
from mcflow.mc_flow_case import McFlowCase
...
def test_tot_inflows_case_2():
    ...
    test_case = McFlowCase(test_setting, test_path)
...
def test_density_case_3():
    ...
    for key,value in expected_values.items():
        ...
        check =np.isclose(value, test_dict[key], rtol=1e-04, atol=1e-08)
...
def test_reynolds_case_3():
    ...
    for key,value in expected_values.items():
        a_vec.append(value)
        b_vec.append(test_dict[key])
        check =np.isclose(value, test_dict[key], rtol=0, atol=1)
        check_vec.append(check)
        if not check:
            print('key: ', key)
            print('expected value: ', value)
...
def test_bulk_velocity_case_3():
    ...
    for key,value in expected_values.items():
        a_vec.append(value)
        b_vec.append(test_dict[key])
        check =np.isclose(value, test_dict[key], rtol=1e-03, atol=1e-08)
        check_vec.append(check)
        if not check:
            print('key: ', key)
            print('expected value: ', value)
...
def test_out_activity_pipe_uniform_case_3():
    ...
    for key,value in expected_values.items():
        a_vec.append(value)
        b_vec.append(test_dict[key])
        check =np.isclose(value, test_dict[key], rtol=5*precision, atol=1e-08)
        check_vec.append(check)
        if not check:
            print('key: ', key)
            print('expected value: ', value)
...
def test_mass_flow_case_4():
    ...
    for key,value in expected_values.items():
        a_vec.append(value)
        b_vec.append(test_dict[key])
        check =np.isclose(value, test_dict[key], rtol=1e-05, atol=1e-08)
        check_vec.append(check)
        if not check:
            print('key: ', key)
            print('expected value: ', value)
